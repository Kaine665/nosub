...
> Name ≤ 75 chars · Short description ≤ 132 chars  
> Primary = English. Add Simplified Chinese as a localized listing.
...
- **A** — Repeat the current sentence. Press again to go back one sentence.
- **S** — Cycle captions: hidden → original → original + translation.
...
- Compact toolbar popup: pause NoSub or open full settings.
...
### Suggested search keywords (for your own tracking)

youtube listening, english listening practice, sentence repeat, youtube subtitles, shadowing, 精听
...
1. Run `pnpm zip` (or `pnpm build`).
2. Upload the built zip.
3. Paste the English text as the primary listing.
4. Add the Simplified Chinese localized listing (name + short + detailed).
5. Upload screenshots that match the A/S/D/E flow.
6. Complete privacy / permission disclosures before submission.
